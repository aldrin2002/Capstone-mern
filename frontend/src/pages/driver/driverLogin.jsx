...
const DriverLoginPage = () => {
  ...
  const { driverLogin, isLoading } = useAuthStore();
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 flex items-center justify-center bg-gradient-to-r from-brand to-primary-700"
    >
      {/* Meteor Effect */}
      <div className="fixed inset-0 pointer-events-none">
        {[...Array(30)].map((_, i) => (
          ...
          >
            <div className="absolute h-0.5 w-[100px] bg-gradient-to-r from-white to-transparent" />
          </div>
        ))}
      </div>
