          ...
          <div className="container mx-auto px-4 py-4 md:py-6">
            <nav className="flex overflow-x-auto pb-2 hide-scrollbar space-x-2 md:space-x-3">
              {categories.map((category, index) => (
                <button
                  ...
                  className={`group flex items-center justify-center px-4 py-2.5 md:px-6 md:py-3 whitespace-nowrap text-xs md:text-sm font-semibold rounded-xl md:rounded-2xl transition-all duration-500 transform hover:scale-105 relative overflow-hidden min-w-0 flex-shrink-0 ${
                    activeCategory === category
                      ? "bg-gradient-to-r from-brand via-primary-700 to-primary-900 text-white shadow-xl shadow-brand/25"
                ...
                >
                  {/* Button glow effect */}
                  <div className={`absolute inset-0 bg-gradient-to-r from-brand/20 to-purple-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl md:rounded-2xl ${
                  ...
                  <div className={`relative ml-1.5 md:ml-3 px-2 md:px-3 py-0.5 md:py-1 text-xs font-bold rounded-full transition-all duration-300 flex items-center justify-center ${
                    activeCategory === category
                      ...
                      : "bg-gray-100 text-gray-600 group-hover:bg-primary-100 group-hover:text-primary-800 border border-gray-200"
                  }`}>
          ...
          {isLoading ? (
              ...
              <div className="text-center">
                <div className="relative mb-8">
                  ...
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    <ChefHat className="h-8 w-8 text-brand animate-pulse" />
                  </div>
                  {/* Outer ring */}
            ...
            <div className="text-center py-24">
              <div className="max-w-lg mx-auto">
                <div className="relative mb-12">
                  ...
                  <div className="absolute -top-4 -right-4 w-12 h-12 bg-gradient-to-br from-primary-400 to-purple-500 rounded-full flex items-center justify-center shadow-xl animate-bounce-gentle">
                ...
                <h3 className="text-3xl font-bold bg-gradient-to-r from-gray-800 to-brand bg-clip-text text-transparent mb-6">No items available</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 pb-16">
              {filteredProducts.map((product, index) => (
                ...
                >
                  {/* Card glow effect */}
                  <div className="absolute inset-0 bg-gradient-to-br from-brand/10 via-purple-500/10 to-brand/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
                  ...
                  <div className="p-6 relative">
                    <div className="mb-4">
                      <h3 className="text-xl font-bold text-gray-900 mb-2 line-clamp-1 group-hover:text-brand transform group-hover:scale-105 transition-all duration-300">
                        {product.name}
                      </h3>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="px-3 py-1.5 text-xs font-bold bg-gradient-to-r from-primary-100 to-primary-200 text-primary-900 rounded-full border border-primary-200">
                        {product.category}
                      </span>
                    </div>
                    
                    {/* Decorative elements */}
                    <div className="absolute bottom-2 right-2 w-2 h-2 bg-primary-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-pulse"></div>
                  </div>
                </div>
              ))}
            </div>
