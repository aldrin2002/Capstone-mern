...
const SideNav = ({ active, setActive }) => {
    ...
    if (isMobile) {
        return (
            <>
                    ...
                    {isExpanded && (
                        <>
                            ...
                            <button
                                ...
                                className="bg-brand text-white p-3 rounded-full shadow-lg hover:bg-primary-700 transition-all transform animate-fadeIn relative"
                                aria-label="Messages"
                            >
                            ...
                            <button
                                ...
                                className="bg-brand text-white p-3 rounded-full shadow-lg hover:bg-primary-700 transition-all transform animate-fadeIn"
                                aria-label="Contact"
                            >
                                <Phone size={24} />
                            </button>
                ...
                {/* Bottom Navigation */}
                <div className="fixed bottom-0 left-0 right-0 bg-primary-900 text-white z-40 shadow-lg">
                            ...
                            return (
                                <button 
                                    ...
                                    className={`flex flex-col items-center justify-center w-full h-full ${
                                        active === item.id ? "text-primary-200" : "text-white"
                                    }`}
                                >
    ...
    // Desktop view
    return (
        <div className="h-screen w-64 bg-primary-900 bg-opacity-90 backdrop-filter backdrop-blur-lg text-white flex flex-col shadow-xl">
            <div className="p-6 border-b border-primary-800">
                <h2 className="text-2xl font-bold text-white">Cafe<span className="text-primary-200"> Delicity</span></h2>
            ...
            <div className="p-4 border-t border-primary-800">
                <button 
                    onClick={handleLogout}
                    className="w-full flex items-center px-4 py-3 text-primary-200 hover:bg-primary-800 rounded-lg transition-colors duration-200"
                >
